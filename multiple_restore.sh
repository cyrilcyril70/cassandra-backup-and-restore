...
A2="acedemic-7935e4d08d9811e786756fe3109cdf0a"
...
cp "$BACKUPDIRECTORY/$A2/"* "$MAINDIRECTORY/$A2"

#like this multiple tables can be restored
#ls -l > file.txt execute in ur backup directory, all the list of tables names will be written in the file. (optional)
#use excel to generate and assign to the variables and copy cmd's (optional)
